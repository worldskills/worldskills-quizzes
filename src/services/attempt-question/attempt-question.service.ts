...
export class AttemptQuestionService {
  ...
  updateResponse(attemptId: number, attemptQuestion: AnsweredQuestionWithAnswers, locale: string): Observable<AnsweredQuestionWithAnswers> {
    ...
    return this.http.put<AnsweredQuestionWithAnswers>(
      `${environment.worldskillsApiEndpoint}/quizzes/attempts/${attemptId}/questions/${attemptQuestion.id}/response`,
  ...
  updateAttemptQuestion(attemptId: number, attemptQuestion: AnsweredQuestionWithAnswers, locale: string): Observable<AnsweredQuestionWithAnswers> {
    ...
    params.set('l', locale);
    return this.http.put<AnsweredQuestionWithAnswers>(
      `${environment.worldskillsApiEndpoint}/quizzes/attempts/${attemptId}/questions/${attemptQuestion.id}`,
      attemptQuestion, {params}
    );
  }
